...
public class ReservationsController : Controller
{
    ...
    /// <summary>
    /// Index action that redirects to the New reservation page, where users can select dates and view available cars.
    /// </summary>
    [HttpGet]
    ...
    /// <summary>
    /// Shows available cars for the specified date range
    /// </summary>
    [HttpPost]
    ...
    /// <summary>
    /// Shows available cars for the previously selected date range
    /// </summary>
    /// <returns></returns>
    [HttpGet]
    ...
    /// <summary>
    /// User makes a reservation for a specific car and date range
    /// </summary>
    [HttpPost]
    ...
    /// <summary>
    /// Manage reservations for admin users, allowing them to view all reservations and approve or reject them.
    /// </summary>
    ...
    /// <summary>
    /// Approve a reservation by changing its status to "Approved". Only accessible to admin users.
    /// </summary>
    [Authorize(Roles = "Admin")]
    ...
    /// <summary>
    /// Reject a reservation by changing its status to "Rejected". Only accessible to admin users.
    /// </summary>
    /// <param name="id"></param>
    /// <returns></returns>
    [Authorize(Roles = "Admin")]
